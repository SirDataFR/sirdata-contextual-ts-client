...
exports.apiUrl = "https://contextual-content.sirdata.io/api/v1";
...
},{"./http":2,"./models/page_categorization_response":6,"./rest/contextual":9}],2:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
var error_1 = require("./rest/error");
var HttpClient = /** @class */ (function () {
    function HttpClient(token) {
        this._token = token;
        this._api_url = contextual_1.apiUrl;
        this.httpClient = axios_1.default.create({
            baseURL: this._api_url,
            maxRedirects: 1,
        });
    }
    HttpClient.prototype.setTimeout = function (ms) {
        this.httpClient.defaults.timeout = ms;
    };
    HttpClient.prototype.setHeaders = function (options) {
    ...
    HttpClient.prototype.setApiUrl = function (url) {
        this._api_url = url;
    };
    HttpClient.prototype.get = function (model, path, options) {
        return __awaiter(this, void 0, void 0, function () {
            var resp, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.httpClient.get(path, this.setHeaders(options))];
                    case 1:
                        resp = _a.sent();
                    ...
                    case 2:
                        error_2 = _a.sent();
                        throw new error_1.ErrorResponse(error_2);
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    HttpClient.prototype.post = function (model, path, body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var resp, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.httpClient.post(path, body.toJson(), this.setHeaders(options))];
                    case 1:
                        resp = _a.sent();
                        model.load(resp.data);
                        return [2 /*return*/, model];
                    case 2:
                        error_3 = _a.sent();
                        throw new error_1.ErrorResponse(error_3);
                    case 3: return [2 /*return*/];
                }
            });
        });
...
},{"./contextual":1,"./rest/error":10,"axios":13}],3:[function(require,module,exports){
"use strict";
...
var contextual_1 = require("../contextual");
var modeled_category_1 = require("./modeled_category");
var PageCategorizationResponse = /** @class */ (function (_super) {
    ...
    function PageCategorizationResponse() {
        ...
        _this._modeled_categories = null;
    ...
    Object.defineProperty(PageCategorizationResponse.prototype, "modeled_categories", {
        get: function () {
        ...
        set: function (values) {
            ...
            var list = [];
            for (var i in values) {
                list.push(new modeled_category_1.ModeledCategory(values[i]));
            }
    ...
    PageCategorizationResponse.prototype.getCategoryIds = function () {
        ...
        if (this.modeled_categories) {
            for (var i in this.modeled_categories) {
                if (this.modeled_categories[i].relevancy >= contextual_1.Contextual.minModeledRelevancy) {
...
},{"../contextual":1,"./category":3,"./model":4,"./modeled_category":5,"./virtual_keyword":8}],7:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
var PageContent = /** @class */ (function (_super) {
    ...
    PageContent.prototype.setContent = function (content) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var model_1 = require("./model");
var VirtualKeyword = /** @class */ (function (_super) {
    __extends(VirtualKeyword, _super);
    function VirtualKeyword() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return VirtualKeyword;
}(model_1.Model));
exports.VirtualKeyword = VirtualKeyword;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        pc.setContent(text);
                        return [4 /*yield*/, this.conf.post(new page_categorization_response_1.PageCategorizationResponse(), RestContextual.contextualPath + (url ? "?url=" + url : ""), pc)];
                    case 1:
                        resp = _a.sent();
                        if (!resp) {
                            return [2 /*return*/, new page_categorization_response_1.PageCategorizationResponse()];
    ...
    RestContextual.prototype.categorizePageByUrl = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.conf.get(new page_categorization_response_1.PageCategorizationResponse(), RestContextual.contextualPath + "?url=" + url)];
            });
        });
    };
    RestContextual.contextualPath = '/content';
    return RestContextual;
}(rest_1.Rest));
exports.RestContextual = RestContextual;

},{"../models/page_categorization_response":6,"../models/page_content":7,"../utils/page_sanetizer":12,"./rest":11}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var tagToRemove = ["aside", "iframe", "footer", "nav", "form", "script", "input", "ul",
    ...
    "div[class=\"rte\"]", "[class*='footer'i]", "noscript"];
...
},{"./adapters/http":14,"./adapters/xhr":14,"./helpers/normalizeHeaderName":34,"./utils":37,"_process":39}],28:[function(require,module,exports){
'use strict';
