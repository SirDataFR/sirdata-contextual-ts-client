...
},{"./http":2,"./models/page_categorization_response":5,"./rest/contextual":8}],2:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"./contextual":1,"./rest/error":9,"axios":12}],3:[function(require,module,exports){
"use strict";
...
var RestContextual = /** @class */ (function (_super) {
    ...
    RestContextual.prototype.categorizePageFromHTMLContent = function (html, url) {
        return this.categorizePageFromTextContent(page_sanetizer_1.PageSanetizer.getTextFromDocument(html ? html : window.document.body), url);
    };
...
},{"../models/page_categorization_response":5,"../models/page_content":6,"../utils/page_sanetizer":11,"./rest":10}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var PageSanetizer = /** @class */ (function () {
    ...
    PageSanetizer.getTextFromDocument = function (element) {
        ...
        for (var tagIndex in tagToRemove) {
            var tags = body.getElementsByTagName(tagToRemove[tagIndex]);
